...
export const T = {
  de: {
    ...
    downloadJSON:  '⬇ Sicherungsdatei herunterladen',
    restoreJSON:   '⬆ Aus Sicherungsdatei wiederherstellen',
  ...
  en: {
    ...
    downloadJSON:  '⬇ Download backup file',
  ...
  ar: {
    ...
    downloadJSON:  '⬇ تحميل ملف النسخة الاحتياطية',
    restoreJSON:   '⬆ استعادة من ملف النسخة الاحتياطية',
    archiveBtnLbl: '💾 أرشفة',
